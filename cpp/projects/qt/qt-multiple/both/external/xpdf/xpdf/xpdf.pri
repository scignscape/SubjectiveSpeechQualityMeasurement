...
#SRC_DIR = C:\repos\kauv-rz\cpp\src\rpdf\xpdf

RESOURCES += \
    $$SRC_DIR/xpdf-qt/icons.qrc

#LIBS += -LC:/xpdf/freetype -lqtfreetyped

LIBS +=  -lqtfreetyped  -lqtlibpngd -lz


#INCLUDEPATH += C:/xpdf/xpdf-4.00

INCLUDEPATH += $$SRC_DIR/
INCLUDEPATH += $$SRC_DIR/aconf
INCLUDEPATH += $$SRC_DIR/goo
#INCLUDEPATH += C:/qtsrc/qt5/qtbase/src/3rdparty/freetype/include
...
##DEFINES += LOAD_FONTS_FROM_MEM=1

##INCLUDEPATH += C:/xpdf/xpdf-4.00
##INCLUDEPATH += C:/xpdf/xpdf-4.00/goo
##INCLUDEPATH += C:/qtsrc/qt5/qtbase/src/3rdparty/freetype/include
##INCLUDEPATH += C:/xpdf/xpdf-4.00/fofi
##INCLUDEPATH += C:/xpdf/xpdf-4.00/splash
##INCLUDEPATH += C:/xpdf/xpdf-4.00/xpdf
...
#INCLUDEPATH += $$SRC_DIR $$SRC_GROUP_DIR $$SRC_DIR/aconf $$SRC_DIR/goo \
#  $$SRC_DIR/xpdf-qt $$SRC_DIR/xpdf $$SRC_DIR/fofi $$SRC_DIR/splash $$SRC_DIR/freetype
