...
(setq kto (ka::kc :|kcm_type_object__str|))
(ka::kc :|kcg_add_lambda_carrier_via_typed_literal| kcg kto "de")
...
(setq kcx (ka::kc :|kcm_dissolve_to_nested_expression| kcg))
(ka::kc :|kcm_prepare_nested_defer_expression| kcx 14 0 1)
(ka::kc :|kcm_hold_deferred| 14 '(progn 
;; held ...
...
(setq kcx (ka::kc :|kcm_dissolve_to_nested_expression| kcg))
(ka::kc :|kcm_prepare_nested_defer_expression| kcx 15 0 1)
(ka::kc :|kcm_hold_deferred| 15 '(progn 
;; held ...
...
(ka::kc :|kcm_prepare_nested_defer_expression| kcx 16 0 3)
(ka::kc :|kcm_hold_deferred| 16 '(progn 
;; held ...
...
(setq kcx (ka::kc :|kcm_dissolve_to_nested_expression| kcg))
(ka::kc :|kcm_prepare_nested_defer_expression| kcx 17 0 1)
(ka::kc :|kcm_hold_deferred| 17 '(progn 
;; held ...

(ka::kc :|_kcm_hold_opaque_lisp_value| :|#hold<0-1>| 
'( format  t  "review, x = ~a~%"  (ka::ivof "x") )
) ;_hold 
...
(ka::kc :|kcm_kcg_add_fuxe_carrier| kcg kto  "prs")
(setq kto (ka::kc :|kcm_type_object__str|))
(ka::kc :|kcg_add_lambda_carrier_via_typed_literal| kcg kto "done.")
(setq kcx (ka::kc :|kcm_dissolve_to_nested_expression| kcg))
(setq kcs (ka::kc :|kcm_promote_expression_to_statement| kcx))
(setq cmd-pkg (ka::kc :|kcm_statement_to_command_package| kcs))
(ka::kc :|kcm_direct_eval| cmd-pkg)
